                ...
                <View style={{flex:1,justifyContent:'center', alignItems:'center'}}>
                  ...
                  <View style={styles.container}>
                          <View style={{flexDirection:'row', justifyContent:'center'}}>
                            <Text style={{...styles.title, fontFamily:'Poppins_200ExtraLight',letterSpacing:-1.6 }}>InStyle</Text>
                            <Text style={{...styles.title, fontFamily:'Poppins_900Black',letterSpacing:-1.8 }}>.Co</Text>
                          </View>
